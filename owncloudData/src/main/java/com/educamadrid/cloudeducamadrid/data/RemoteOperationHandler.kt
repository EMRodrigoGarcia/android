...
import com.educamadrid.cloudeducamadrid.domain.exceptions.AccountException
import com.educamadrid.cloudeducamadrid.domain.exceptions.AccountNotFoundException
import com.educamadrid.cloudeducamadrid.domain.exceptions.AccountNotNewException
import com.educamadrid.cloudeducamadrid.domain.exceptions.AccountNotTheSameException
import com.educamadrid.cloudeducamadrid.domain.exceptions.BadOcVersionException
import com.educamadrid.cloudeducamadrid.domain.exceptions.CancelledException
import com.educamadrid.cloudeducamadrid.domain.exceptions.ConflictException
import com.educamadrid.cloudeducamadrid.domain.exceptions.CopyIntoDescendantException
import com.educamadrid.cloudeducamadrid.domain.exceptions.DelayedForWifiException
import com.educamadrid.cloudeducamadrid.domain.exceptions.FileNotFoundException
import com.educamadrid.cloudeducamadrid.domain.exceptions.ForbiddenException
import com.educamadrid.cloudeducamadrid.domain.exceptions.IncorrectAddressException
import com.educamadrid.cloudeducamadrid.domain.exceptions.InstanceNotConfiguredException
import com.educamadrid.cloudeducamadrid.domain.exceptions.InvalidCharacterException
import com.educamadrid.cloudeducamadrid.domain.exceptions.InvalidCharacterInNameException
import com.educamadrid.cloudeducamadrid.domain.exceptions.InvalidLocalFileNameException
import com.educamadrid.cloudeducamadrid.domain.exceptions.InvalidOverwriteException
import com.educamadrid.cloudeducamadrid.domain.exceptions.LocalFileNotFoundException
import com.educamadrid.cloudeducamadrid.domain.exceptions.LocalStorageFullException
import com.educamadrid.cloudeducamadrid.domain.exceptions.LocalStorageNotCopiedException
import com.educamadrid.cloudeducamadrid.domain.exceptions.LocalStorageNotMovedException
import com.educamadrid.cloudeducamadrid.domain.exceptions.LocalStorageNotRemovedException
import com.educamadrid.cloudeducamadrid.domain.exceptions.MoveIntoDescendantException
import com.educamadrid.cloudeducamadrid.domain.exceptions.NoConnectionWithServerException
import com.educamadrid.cloudeducamadrid.domain.exceptions.NoNetworkConnectionException
import com.educamadrid.cloudeducamadrid.domain.exceptions.OAuth2ErrorAccessDeniedException
import com.educamadrid.cloudeducamadrid.domain.exceptions.OAuth2ErrorException
import com.educamadrid.cloudeducamadrid.domain.exceptions.PartialCopyDoneException
import com.educamadrid.cloudeducamadrid.domain.exceptions.PartialMoveDoneException
import com.educamadrid.cloudeducamadrid.domain.exceptions.QuotaExceededException
import com.educamadrid.cloudeducamadrid.domain.exceptions.RedirectToNonSecureException
import com.educamadrid.cloudeducamadrid.domain.exceptions.SSLErrorException
import com.educamadrid.cloudeducamadrid.domain.exceptions.ServerConnectionTimeoutException
import com.educamadrid.cloudeducamadrid.domain.exceptions.ServerNotReachableException
import com.educamadrid.cloudeducamadrid.domain.exceptions.ServerResponseTimeoutException
import com.educamadrid.cloudeducamadrid.domain.exceptions.ServiceUnavailableException
import com.educamadrid.cloudeducamadrid.domain.exceptions.ShareForbiddenException
import com.educamadrid.cloudeducamadrid.domain.exceptions.ShareNotFoundException
import com.educamadrid.cloudeducamadrid.domain.exceptions.ShareWrongParameterException
import com.educamadrid.cloudeducamadrid.domain.exceptions.SpecificForbiddenException
import com.educamadrid.cloudeducamadrid.domain.exceptions.SpecificMethodNotAllowedException
import com.educamadrid.cloudeducamadrid.domain.exceptions.SpecificServiceUnavailableException
import com.educamadrid.cloudeducamadrid.domain.exceptions.SpecificUnsupportedMediaTypeException
import com.educamadrid.cloudeducamadrid.domain.exceptions.SyncConflictException
import com.educamadrid.cloudeducamadrid.domain.exceptions.UnauthorizedException
import com.educamadrid.cloudeducamadrid.domain.exceptions.UnhandledHttpCodeException
import com.educamadrid.cloudeducamadrid.domain.exceptions.UnknownErrorException
import com.educamadrid.cloudeducamadrid.domain.exceptions.WrongServerResponseException
