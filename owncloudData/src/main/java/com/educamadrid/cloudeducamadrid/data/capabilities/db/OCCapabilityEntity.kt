...
package com.educamadrid.cloudeducamadrid.data.capabilities.db

import android.database.Cursor
import androidx.room.ColumnInfo
import androidx.room.Entity
import androidx.room.PrimaryKey
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_ACCOUNT_NAME
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_CORE_POLLINTERVAL
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_DAV_CHUNKING_VERSION
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_FILES_BIGFILECHUNKING
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_FILES_UNDELETE
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_FILES_VERSIONING
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_API_ENABLED
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_FEDERATION_INCOMING
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_FEDERATION_OUTGOING
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_PUBLIC_ENABLED
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_PUBLIC_EXPIRE_DATE_DAYS
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_PUBLIC_EXPIRE_DATE_ENABLED
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_PUBLIC_EXPIRE_DATE_ENFORCED
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_PUBLIC_MULTIPLE
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_PUBLIC_PASSWORD_ENFORCED
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_PUBLIC_PASSWORD_ENFORCED_READ_ONLY
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_PUBLIC_PASSWORD_ENFORCED_READ_WRITE
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_PUBLIC_PASSWORD_ENFORCED_UPLOAD_ONLY
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_PUBLIC_SUPPORTS_UPLOAD_ONLY
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_PUBLIC_UPLOAD
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_RESHARING
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_SHARING_USER_PROFILE_PICTURE
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_TABLE_NAME
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_VERSION_EDITION
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_VERSION_MAYOR
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_VERSION_MICRO
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_VERSION_MINOR
import com.educamadrid.cloudeducamadrid.data.ProviderMeta.ProviderTableMeta.CAPABILITIES_VERSION_STRING
import com.educamadrid.cloudeducamadrid.domain.capabilities.model.CapabilityBooleanType.Companion.capabilityBooleanTypeUnknownString
