...
import com.educamadrid.cloudeducamadrid.data.authentication.KEY_CLIENT_REGISTRATION_CLIENT_EXPIRATION_DATE
import com.educamadrid.cloudeducamadrid.data.authentication.KEY_CLIENT_REGISTRATION_CLIENT_ID
import com.educamadrid.cloudeducamadrid.data.authentication.KEY_CLIENT_REGISTRATION_CLIENT_SECRET
import com.educamadrid.cloudeducamadrid.data.authentication.KEY_OAUTH2_REFRESH_TOKEN
import com.educamadrid.cloudeducamadrid.data.authentication.KEY_OAUTH2_SCOPE
import com.educamadrid.cloudeducamadrid.data.authentication.SELECTED_ACCOUNT
import com.educamadrid.cloudeducamadrid.data.preferences.datasources.SharedPreferencesProvider
import com.educamadrid.cloudeducamadrid.domain.authentication.oauth.model.ClientRegistrationInfo
...
import com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountUtils.Constants.ACCOUNT_VERSION
import com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountUtils.Constants.KEY_DISPLAY_NAME
import com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountUtils.Constants.KEY_OC_ACCOUNT_VERSION
import com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountUtils.Constants.KEY_OC_BASE_URL
import com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountUtils.Constants.KEY_OC_VERSION
import com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountUtils.Constants.KEY_SUPPORTS_OAUTH2
import com.educamadrid.cloudeducamadrid.testutil.OC_ACCESS_TOKEN
import com.educamadrid.cloudeducamadrid.testutil.OC_ACCOUNT
import com.educamadrid.cloudeducamadrid.testutil.OC_ACCOUNT_ID
import com.educamadrid.cloudeducamadrid.testutil.OC_ACCOUNT_NAME
import com.educamadrid.cloudeducamadrid.testutil.OC_AUTH_TOKEN_TYPE
import com.educamadrid.cloudeducamadrid.testutil.OC_BASE_URL
import com.educamadrid.cloudeducamadrid.testutil.OC_BASIC_USERNAME
import com.educamadrid.cloudeducamadrid.testutil.OC_OAUTH_SUPPORTED_TRUE
import com.educamadrid.cloudeducamadrid.testutil.OC_REDIRECTION_PATH
import com.educamadrid.cloudeducamadrid.testutil.OC_REFRESH_TOKEN
import com.educamadrid.cloudeducamadrid.testutil.OC_SCOPE
import com.educamadrid.cloudeducamadrid.testutil.OC_SERVER_INFO
import com.educamadrid.cloudeducamadrid.testutil.OC_USER_INFO
import com.educamadrid.cloudeducamadrid.testutil.oauth.OC_CLIENT_REGISTRATION
