...
package com.educamadrid.cloudeduca.data.authentication.datasources.implementation
...
import com.educamadrid.cloudeduca.data.authentication.KEY_CLIENT_REGISTRATION_CLIENT_EXPIRATION_DATE
import com.educamadrid.cloudeduca.data.authentication.KEY_CLIENT_REGISTRATION_CLIENT_ID
import com.educamadrid.cloudeduca.data.authentication.KEY_CLIENT_REGISTRATION_CLIENT_SECRET
import com.educamadrid.cloudeduca.data.authentication.KEY_OAUTH2_REFRESH_TOKEN
import com.educamadrid.cloudeduca.data.authentication.KEY_OAUTH2_SCOPE
import com.educamadrid.cloudeduca.data.authentication.SELECTED_ACCOUNT
import com.educamadrid.cloudeduca.data.preferences.datasources.SharedPreferencesProvider
import com.educamadrid.cloudeduca.domain.authentication.oauth.model.ClientRegistrationInfo
...
import com.educamadrid.cloudeduca.domain.user.model.UserInfo
import com.educamadrid.cloudeduca.lib.common.accounts.AccountUtils.Constants.ACCOUNT_VERSION
import com.educamadrid.cloudeduca.lib.common.accounts.AccountUtils.Constants.KEY_DISPLAY_NAME
import com.educamadrid.cloudeduca.lib.common.accounts.AccountUtils.Constants.KEY_OC_ACCOUNT_VERSION
import com.educamadrid.cloudeduca.lib.common.accounts.AccountUtils.Constants.KEY_OC_BASE_URL
import com.educamadrid.cloudeduca.lib.common.accounts.AccountUtils.Constants.KEY_OC_VERSION
import com.educamadrid.cloudeduca.lib.common.accounts.AccountUtils.Constants.KEY_SUPPORTS_OAUTH2
import com.educamadrid.cloudeduca.testutil.OC_ACCESS_TOKEN
import com.educamadrid.cloudeduca.testutil.OC_ACCOUNT
import com.educamadrid.cloudeduca.testutil.OC_ACCOUNT_ID
import com.educamadrid.cloudeduca.testutil.OC_ACCOUNT_NAME
import com.educamadrid.cloudeduca.testutil.OC_AUTH_TOKEN_TYPE
import com.educamadrid.cloudeduca.testutil.OC_BASE_URL
import com.educamadrid.cloudeduca.testutil.OC_BASIC_USERNAME
import com.educamadrid.cloudeduca.testutil.OC_OAUTH_SUPPORTED_TRUE
import com.educamadrid.cloudeduca.testutil.OC_REDIRECTION_PATH
import com.educamadrid.cloudeduca.testutil.OC_REFRESH_TOKEN
import com.educamadrid.cloudeduca.testutil.OC_SCOPE
import com.educamadrid.cloudeduca.testutil.OC_SERVER_INFO
import com.educamadrid.cloudeduca.testutil.OC_USER_INFO
