 ...
 */
package com.educamadrid.cloudeduca.data.user

import androidx.arch.core.executor.testing.InstantTaskExecutorRule
import androidx.test.filters.MediumTest
import androidx.test.platform.app.InstrumentationRegistry
import com.educamadrid.cloudeduca.data.OwncloudDatabase
import com.educamadrid.cloudeduca.data.user.datasources.implementation.OCLocalUserDataSource.Companion.toEntity
import com.educamadrid.cloudeduca.data.user.datasources.implementation.OCLocalUserDataSource.Companion.toModel
import com.educamadrid.cloudeduca.data.user.db.UserDao
import com.educamadrid.cloudeduca.testutil.OC_ACCOUNT_NAME
import com.educamadrid.cloudeduca.testutil.OC_USER_QUOTA
