...
package com.educamadrid.cloudeducamadrid.operations.common;
...
public abstract class SyncOperation<T> extends RemoteOperation<T> {
     ...
     * {@link #execute(OwnCloudClient, com.educamadrid.cloudeducamadrid.datamodel.FileDataStorageManager)}.
     *
