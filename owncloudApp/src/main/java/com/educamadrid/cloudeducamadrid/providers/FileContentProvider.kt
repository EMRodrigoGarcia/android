...
import com.educamadrid.cloudeducamadrid.data.Executors
import com.educamadrid.cloudeducamadrid.data.OwncloudDatabase
import com.educamadrid.cloudeducamadrid.data.ProviderMeta
import com.educamadrid.cloudeducamadrid.data.capabilities.datasources.implementation.OCLocalCapabilitiesDataSource
import com.educamadrid.cloudeducamadrid.data.capabilities.datasources.implementation.OCLocalCapabilitiesDataSource.Companion.toModel
...
import com.educamadrid.cloudeducamadrid.data.migrations.CameraUploadsMigrationToRoom
...
import com.educamadrid.cloudeducamadrid.db.ProviderMeta.ProviderTableMeta
import com.educamadrid.cloudeducamadrid.domain.files.LIST_MIME_DIR
...
class FileContentProvider(val executors: Executors = Executors()) : ContentProvider() {
     ...
     *
     * See [com.educamadrid.cloudeducamadrid.authentication.AccountUtils.updateAccountVersion]
     *
