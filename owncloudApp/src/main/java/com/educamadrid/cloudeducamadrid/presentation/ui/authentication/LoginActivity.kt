...
package com.educamadrid.cloudeducamadrid.presentation.ui.authentication
...
import com.educamadrid.cloudeducamadrid.MainApp.Companion.accountType
import com.educamadrid.cloudeducamadrid.R
import com.educamadrid.cloudeducamadrid.authentication.oauth.OAuthUtils
import com.educamadrid.cloudeducamadrid.data.authentication.KEY_USER_ID
import com.educamadrid.cloudeducamadrid.data.authentication.OAUTH2_OIDC_SCOPE
import com.educamadrid.cloudeducamadrid.databinding.AccountSetupBinding
import com.educamadrid.cloudeducamadrid.domain.authentication.oauth.model.ResponseType
import com.educamadrid.cloudeducamadrid.domain.authentication.oauth.model.TokenRequest
import com.educamadrid.cloudeducamadrid.domain.exceptions.NoNetworkConnectionException
import com.educamadrid.cloudeducamadrid.domain.exceptions.OwncloudVersionNotSupportedException
import com.educamadrid.cloudeducamadrid.domain.exceptions.ServerNotReachableException
import com.educamadrid.cloudeducamadrid.domain.exceptions.StateMismatchException
import com.educamadrid.cloudeducamadrid.domain.exceptions.UnauthorizedException
import com.educamadrid.cloudeducamadrid.domain.server.model.AuthenticationMethod
...
import com.educamadrid.cloudeducamadrid.extensions.goToUrl
import com.educamadrid.cloudeducamadrid.extensions.manageOptionLockSelected
import com.educamadrid.cloudeducamadrid.extensions.parseError
import com.educamadrid.cloudeducamadrid.extensions.showErrorInToast
...
import com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountTypeUtils
...
import com.educamadrid.cloudeducamadrid.presentation.ui.settings.SettingsActivity
...
import com.educamadrid.cloudeducamadrid.ui.dialog.SslUntrustedCertDialog
import com.educamadrid.cloudeducamadrid.utils.DocumentProviderUtils.Companion.notifyDocumentProviderRoots
