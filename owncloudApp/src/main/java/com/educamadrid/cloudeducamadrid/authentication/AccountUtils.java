...
import com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountUtils.Constants;
import com.educamadrid.cloudeducamadrid.lib.resources.status.OwnCloudVersion;
import timber.log.Timber;

import java.util.Locale;

import static com.educamadrid.cloudeducamadrid.data.authentication.AuthenticationConstantsKt.SELECTED_ACCOUNT;
import static com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountUtils.Constants.OAUTH_SUPPORTED_TRUE;
        ...
        if (currentAccount != null) {
            ...
            if (currentAccountVersion == null) {
                ...
                for (Account account : ocAccounts) {
                    ...
                    username = com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountUtils.
                            getUsernameForAccount(account);
                    newAccountName = com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountUtils.
