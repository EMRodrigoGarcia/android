...
import com.educamadrid.cloudeducamadrid.AppRater
import com.educamadrid.cloudeducamadrid.BuildConfig
import com.educamadrid.cloudeducamadrid.MainApp
import com.educamadrid.cloudeducamadrid.R
import com.educamadrid.cloudeducamadrid.databinding.ActivityMainBinding
...
import com.educamadrid.cloudeducamadrid.extensions.checkPasscodeEnforced
import com.educamadrid.cloudeducamadrid.extensions.manageOptionLockSelected
import com.educamadrid.cloudeducamadrid.extensions.showMessageInSnackbar
import com.educamadrid.cloudeducamadrid.files.services.FileDownloader
import com.educamadrid.cloudeducamadrid.files.services.FileDownloader.FileDownloaderBinder
import com.educamadrid.cloudeducamadrid.files.services.FileUploader
import com.educamadrid.cloudeducamadrid.files.services.FileUploader.FileUploaderBinder
import com.educamadrid.cloudeducamadrid.files.services.TransferRequester
import com.educamadrid.cloudeducamadrid.interfaces.ISecurityEnforced
import com.educamadrid.cloudeducamadrid.interfaces.LockType
import com.educamadrid.cloudeducamadrid.lib.common.authentication.OwnCloudBearerCredentials
...
import com.educamadrid.cloudeducamadrid.operations.CopyFileOperation
import com.educamadrid.cloudeducamadrid.operations.CreateFolderOperation
import com.educamadrid.cloudeducamadrid.operations.MoveFileOperation
import com.educamadrid.cloudeducamadrid.operations.RefreshFolderOperation
import com.educamadrid.cloudeducamadrid.operations.RemoveFileOperation
import com.educamadrid.cloudeducamadrid.operations.RenameFileOperation
import com.educamadrid.cloudeducamadrid.operations.SynchronizeFileOperation
import com.educamadrid.cloudeducamadrid.operations.UploadFileOperation
import com.educamadrid.cloudeducamadrid.presentation.ui.security.bayPassUnlockOnce
import com.educamadrid.cloudeducamadrid.syncadapter.FileSyncAdapter
import com.educamadrid.cloudeducamadrid.ui.errorhandling.ErrorMessageAdapter
import com.educamadrid.cloudeducamadrid.ui.fragment.FileDetailFragment
import com.educamadrid.cloudeducamadrid.ui.fragment.FileFragment
import com.educamadrid.cloudeducamadrid.ui.fragment.OCFileListFragment
import com.educamadrid.cloudeducamadrid.ui.fragment.TaskRetainerFragment
import com.educamadrid.cloudeducamadrid.ui.helpers.FilesUploadHelper
import com.educamadrid.cloudeducamadrid.ui.helpers.UriUploader
import com.educamadrid.cloudeducamadrid.ui.preview.PreviewAudioFragment
import com.educamadrid.cloudeducamadrid.ui.preview.PreviewImageActivity
import com.educamadrid.cloudeducamadrid.ui.preview.PreviewImageFragment
import com.educamadrid.cloudeducamadrid.ui.preview.PreviewTextFragment
import com.educamadrid.cloudeducamadrid.ui.preview.PreviewVideoActivity
import com.educamadrid.cloudeducamadrid.ui.preview.PreviewVideoFragment
import com.educamadrid.cloudeducamadrid.utils.Extras
import com.educamadrid.cloudeducamadrid.utils.PreferenceUtils
                        ...
                        if (!synchResult?.isSuccess!!) {
                            ...
                            if (ResultCode.UNAUTHORIZED == synchResult.code ||
                                ...
                                launch(Dispatchers.IO) {
                                    val credentials =
                                        com.educamadrid.cloudeducamadrid.lib.common.accounts.AccountUtils.getCredentialsForAccount(
                                            MainApp.appContext,
                                            account
                                        )
