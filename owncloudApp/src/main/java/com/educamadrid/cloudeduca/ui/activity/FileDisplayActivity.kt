...
package com.educamadrid.cloudeduca.ui.activity
...
import com.educamadrid.cloudeduca.AppRater
...
import com.educamadrid.cloudeduca.databinding.ActivityMainBinding
import com.educamadrid.cloudeduca.datamodel.FileDataStorageManager
import com.educamadrid.cloudeduca.datamodel.OCFile
import com.educamadrid.cloudeduca.extensions.checkPasscodeEnforced
import com.educamadrid.cloudeduca.extensions.manageOptionLockSelected
import com.educamadrid.cloudeduca.extensions.showMessageInSnackbar
import com.educamadrid.cloudeduca.files.services.FileDownloader
import com.educamadrid.cloudeduca.files.services.FileDownloader.FileDownloaderBinder
import com.educamadrid.cloudeduca.files.services.FileUploader
import com.educamadrid.cloudeduca.files.services.FileUploader.FileUploaderBinder
import com.educamadrid.cloudeduca.files.services.TransferRequester
import com.educamadrid.cloudeduca.interfaces.ISecurityEnforced
import com.educamadrid.cloudeduca.interfaces.LockType
import com.educamadrid.cloudeduca.lib.common.authentication.OwnCloudBearerCredentials
...
import com.educamadrid.cloudeduca.operations.CopyFileOperation
import com.educamadrid.cloudeduca.operations.CreateFolderOperation
import com.educamadrid.cloudeduca.operations.MoveFileOperation
import com.educamadrid.cloudeduca.operations.RefreshFolderOperation
import com.educamadrid.cloudeduca.operations.RemoveFileOperation
import com.educamadrid.cloudeduca.operations.RenameFileOperation
...
import com.educamadrid.cloudeduca.ui.fragment.FileFragment
import com.educamadrid.cloudeduca.ui.fragment.OCFileListFragment
import com.educamadrid.cloudeduca.ui.fragment.TaskRetainerFragment
import com.educamadrid.cloudeduca.ui.helpers.FilesUploadHelper
import com.educamadrid.cloudeduca.ui.helpers.UriUploader
import com.educamadrid.cloudeduca.ui.preview.PreviewAudioFragment
import com.educamadrid.cloudeduca.ui.preview.PreviewImageActivity
import com.educamadrid.cloudeduca.ui.preview.PreviewImageFragment
                        ...
                        if (!synchResult?.isSuccess!!) {
                            ...
                            if (ResultCode.UNAUTHORIZED == synchResult.code ||
                                ...
                                launch(Dispatchers.IO) {
                                    val credentials =
                                        com.educamadrid.cloudeduca.lib.common.accounts.AccountUtils.getCredentialsForAccount(
                                            MainApp.appContext,
                                            account
                                        )
