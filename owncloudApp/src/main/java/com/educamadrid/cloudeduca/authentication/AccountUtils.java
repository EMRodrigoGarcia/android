...
import com.educamadrid.cloudeduca.lib.common.accounts.AccountUtils.Constants;
import com.educamadrid.cloudeduca.lib.resources.status.OwnCloudVersion;
import timber.log.Timber;

import java.util.Locale;

import static com.educamadrid.cloudeduca.data.authentication.AuthenticationConstantsKt.SELECTED_ACCOUNT;
import static com.educamadrid.cloudeduca.lib.common.accounts.AccountUtils.Constants.OAUTH_SUPPORTED_TRUE;
        ...
        if (currentAccount != null) {
            ...
            if (currentAccountVersion == null) {
                ...
                for (Account account : ocAccounts) {
                    ...
                    username = com.educamadrid.cloudeduca.lib.common.accounts.AccountUtils.
                            getUsernameForAccount(account);
                    newAccountName = com.educamadrid.cloudeduca.lib.common.accounts.AccountUtils.
